...
import { PaperclipIcon, SendHorizonal, XIcon } from 'lucide-react';
...
export default function CreatePost() {
  ...
  const setIsOpen = useAppStore((state) => state.setCreatePostAreaIsOpen);
        ...
        <form onSubmit={handleSubmit}>
          <InputGroup className="border-0 shadow-none rounded-none has-[[data-slot=input-group-control]:focus-visible]:ring-0">
            ...
            <InputGroupAddon align="block-start" className="justify-between">
              ...
              <Button
                className=" w-6 h-6 p-1 rounded-full right-3 -top-4 text-black"
